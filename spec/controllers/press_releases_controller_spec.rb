...
describe PressReleasesController do
  ...
  let(:valid_attributes) { { "media_type" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved press_release as @press_release" do
        ...
        post :create, {:press_release => { "media_type" => "invalid value" }}, valid_session
        assigns(:press_release).should be_a_new(PressRelease)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested press_release" do
        ...
        PressRelease.any_instance.should_receive(:update).with({ "media_type" => "MyString" })
        put :update, {:id => press_release.to_param, :press_release => { "media_type" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the press_release as @press_release" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        PressRelease.any_instance.stub(:save).and_return(false)
        put :update, {:id => press_release.to_param, :press_release => { "media_type" => "invalid value" }}, valid_session
        assigns(:press_release).should eq(press_release)
      end
