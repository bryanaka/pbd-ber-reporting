  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved publication as @publication" do
        ...
        post :create, {:publication => { "title" => "invalid value" }}, valid_session
        assigns(:publication).should be_a_new(Publication)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested publication" do
        ...
        Publication.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => publication.to_param, :publication => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the publication as @publication" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Publication.any_instance.stub(:save).and_return(false)
        put :update, {:id => publication.to_param, :publication => { "title" => "invalid value" }}, valid_session
        assigns(:publication).should eq(publication)
      end
